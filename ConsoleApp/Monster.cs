...
public class Monster(int hp, int attack, int defense, string name)
{
    ...
    public bool Shield { get; set; } // no damage taken 
    ...
    private void TakeDamage(int attack)
    {
        ...
        {
            if (Determination == true && Hp > 1 && newHp < 1 && HealCharge == true && Shield == true)
                Hp = (Hp + 30);
            else if (Determination == true && Hp > 1 && newHp < 1 && HealCharge == false && Shield == false)
                Hp = newHp;
            else if (newHp > 0)
                Hp = newHp;
            else if (newHp <= 0)
